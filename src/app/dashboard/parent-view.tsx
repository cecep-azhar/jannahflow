        ...
        {familyData.map((member) => (
          <div key={member.id} className="bg-white dark:bg-slate-900 rounded-2xl shadow-sm p-6 border border-slate-200 dark:border-slate-800">
            <div className="flex items-center gap-4 mb-4">
              ...
              member.role === 'parent' ? 'bg-emerald-100 dark:bg-emerald-900/50 text-emerald-700 dark:text-emerald-400' : 'bg-teal-100 dark:bg-teal-900/50 text-teal-600 dark:text-teal-400'
              }`}>
